...
public class IADLXManualFanTuning1 : IADLXManualFanTuning {
  ...
  public virtual ADLX_RESULT GetMinAcousticLimitDefault(ref int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetMinAcousticLimitDefault(swigCPtr, ref defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetMinFanSpeedDefault(ref int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetMinFanSpeedDefault(swigCPtr, ref defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetTargetFanSpeedDefault(ref int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetTargetFanSpeedDefault(swigCPtr, ref defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetDefaultZeroRPMState(ref bool defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetDefaultZeroRPMState(swigCPtr, ref defaultVal);
    return ret;
  }
